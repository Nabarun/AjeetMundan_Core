...
import {IonicPage, ModalController, MenuController, AlertController, Platform, NavController} from 'ionic-angular';
...
export class AppointmentPage{
  ...
  @ViewChild(GoogleLoginComponent) child: GoogleLoginComponent;
  @ViewChild(FacebookLoginComponent) fbChild: FacebookLoginComponent;
  ngOnInit() {
